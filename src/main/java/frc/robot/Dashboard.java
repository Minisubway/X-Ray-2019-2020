...
public class Dashboard {
    ...
    private static void updatePutShort() {
    	RobotContainer.drive.dashboard();
        RobotContainer.pneumatics.dashboard();
        RobotContainer.elevator.dashboard();
        RobotContainer.climber.dashboard();
        RobotContainer.hatch.dashboard();
        RobotContainer.cargoMech.dashboard();
        RobotContainer.visionLL.dashboard();
        ...
        SmartDashboard.putNumber("Pigeon Heading", RobotContainer.drive.pigeon.getFusedHeading());
        SmartDashboard.putNumber("Piegeon Yaw Rate", RobotContainer.drive.xyz_dps[2]);
