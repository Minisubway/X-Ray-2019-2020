...
public class CargoMech extends SubsystemBase {
	...
	public SpectrumTalonSRX cargoBottomSRX = new SpectrumTalonSRX(Constants.CARGO_BOTTOM);
	...
	public SpectrumSolenoid intakeSol = new SpectrumSolenoid(Constants.CARGO_INTAKE_SOL);
	public SpectrumSolenoid tiltSol = new SpectrumSolenoid(Constants.CARGO_TILT_SOL);
	...
	public void periodic() {
		 //Rumble operator controller when intake is on
		    ...
		    /*if (cargoTopMAX.getAppliedOutput() != 0) {
		    	...
		    	RobotContainer.opController.setRumble(.6, .6);
		    } else {
		    	RobotContainer.opController.setRumble(0, 0);
			} */
			RobotContainer.opController.setRumble(0, 0);
	 }
	...
	public boolean isIntakeComplete() {
		intakeComplete = getIntakeSW() && !RobotContainer.opController.Dpad.Right.get();
	...
	public void dashboard() {
		...
		SmartDashboard.putNumber("Cargo/Top PDP Current", RobotContainer.PDP.getCurrent(10));
