...
public class PathFollower extends SubsystemBase {
  ...
  public int getLeftEncoder(){
    return (int)RobotContainer.drive.leftEncoder.getPosition();
  }

  //Insert how you get the position of your right encoder here
  public int getRightEncoder(){
    return (int)RobotContainer.drive.rightEncoder.getPosition();
  }
  ...
  public void updatePIDVAprefs(){
    double kp = RobotContainer.prefs.getNumber("PathW: P", 0.7);
    double ki = RobotContainer.prefs.getNumber("PathW: I", 0.0);
    double kd = RobotContainer.prefs.getNumber("PathW: D", 0.0);
    double kv = 1 / RobotContainer.prefs.getNumber("PathW: Velocity", 15);
    double ka = RobotContainer.prefs.getNumber("PathW: Accel", 0.0);
