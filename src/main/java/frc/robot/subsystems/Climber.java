...
public class Climber extends SubsystemBase {
  ...
  public Climber() {
    spx = new SpectrumVictorSPX(Constants.CLIMBER_SPX);
    srx = new LeaderTalonSRX(Constants.CLIMBER_SRX, spx);
    kicker = new SpectrumSolenoid(Constants.CLIMBER_SOL);
    sensor = new SpectrumDigitalInput(Constants.CLIMBER_SENSOR);
  ...
  public double getCurrent(){
    return srx.getOutputCurrent() + RobotContainer.PDP.getCurrent(Constants.CLIMBER_SPX); 
  }
  ...
  public boolean checkSystem() {
    ...
    Timer.delay(1.0);
    final double currentSRX = RobotContainer.PDP.getCurrent(Constants.CLIMBER_SRX_PDP);
    srx.set(ControlMode.PercentOutput, 0.0);
    ...
    Timer.delay(1.0);
    final double currentSPX = RobotContainer.PDP.getCurrent(Constants.CLIMBER_SPX_PDP);
    spx.set(ControlMode.PercentOutput, 0.0);
