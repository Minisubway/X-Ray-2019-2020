...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain() {
    leftFrontMotor = new SpectrumSparkMax(Constants.LEFT_DRIVE_FRONT);
    leftMiddleMotor = new SpectrumSparkMax(Constants.LEFT_DRIVE_MIDDLE);
    leftRearMotor = new SpectrumSparkMax(Constants.LEFT_DRIVE_REAR);
    rightFrontMotor = new SpectrumSparkMax(Constants.RIGHT_DRIVE_FRONT);
    rightMiddleMotor = new SpectrumSparkMax(Constants.RIGHT_DRIVE_MIDDLE);
    rightRearMotor = new SpectrumSparkMax(Constants.RIGHT_DRIVE_REAR);
  ...
  public void visionDrive(double speed){
    ...
    if (RobotContainer.visionLL.getLimelightHasValidTarget()){
      steerAdjust = RobotContainer.visionLL.getLimelightSteerCommand();
    }
  ...
  public void dashboard(){
    ...
    SmartDashboard.putNumber("Drive/leftFt", this.ticksToFt(RobotContainer.drive.leftEncoder.getPosition()));
